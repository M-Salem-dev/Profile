...
function startCounter() {
  $(".progressWidth-100").animate({ width: "100%" }, 2e3),
    $(".progressWidth-90").animate({ width: "90%" }, 2e3),
    $(".progressWidth-80").animate({ width: "80%" }, 2e3),
    $(".progressWidth-60").animate({ width: "60%" }, 2e3);
}
...
$(window).scroll(function () {
  $(window).scrollTop() > progressOffsetTop - 170 && startCounter();
}),
  $(function () {
...
var inputName = document.querySelector(".form-group .inputName"),
  ErrorName = document.querySelector(".form-group .ErrorName");
function validationName() {
  return !0 == /^[a-zA-Z]{3,15}$/.test(inputName.value)
...
var inputEmail = document.querySelector(".form-group .inputEmail"),
  ErrorEmail = document.querySelector(".form-group .ErrorEmail");
function validationEmail() {
  return !0 == /^[a-zA-Z]{3,15}$/.test(inputEmail.value)
...
var inputTextarea = document.querySelector(".form-group .inputTextarea"),
  ErrorTextarea = document.querySelector(".form-group .ErrorTextarea");
function textareaName() {
  return !0 == /^[a-zA-Z]{1,100}$/.test(inputTextarea.value)
...
const calcScrollValue = () => {
  let e = document.querySelector("#ScrollToTop"),
    t = document.documentElement.scrollTop,
    a =
      document.documentElement.scrollHeight -
      document.documentElement.clientHeight,
    r = Math.round(Math.floor(100 * t) / a);
  t > 100 ? (e.style.display = "grid") : (e.style.display = "none"),
    e.addEventListener("click", () => {
      window.scrollTo(0, 0);
    }),
    (e.style.background = `conic-gradient(#ad8e6d ${r}%, transparent ${r}%)`);
};
window.addEventListener("scroll", calcScrollValue);
let section = document.querySelectorAll(".section1"),
  navLink = document.querySelectorAll(".box-cilsh-nav a");
window.onscroll = () => {
  section.forEach((e) => {
    ...
    t >= a &&
      ...
      navLink.forEach((e) => {
        e.classList.remove("active-nav"),
          document
            .querySelector(".box-cilsh-nav a[href*=" + o + "]")
...
$("#sideBar").animate({ right: `-${colorBoxWidth}` }, 0),
  $("#sideBarToggle").click(function () {
    "0px" == $("#sideBar").css("right")
      ? $("#sideBar").animate({ right: `-${colorBoxWidth}` }, 2e3)
      : $("#sideBar").animate({ right: "0px" }, 2e3);
  });
...
for (let i = 0; i < $(".color-item").length; i++) {
  ...
  $(".color-item").eq(i).css("backgroundColor", `rgb(${e} ,${t} ,${a} )`);
}
$(".color-item").click(function () {
  let e = $(this).css("backgroundColor");
  $(".color-css-js ,svg.radial-progress text").css("color", e),
    $("svg.radial-progress text").css("fill", e);
});
for (let i = 0; i < $(".Background-color-item").length; i++) {
  ...
  $(".Background-color-item")
    .eq(i)
    .css("backgroundColor", `rgb(${r} ,${o} ,${s} )`);
}
function dt_counterFlip() {
  var e = $(".counterTop").offset().top - window.innerHeight;
...
$(".Background-color-item").click(function () {
  let e = $(this).css("backgroundColor");
  $(".bg-css-js").css("background", e);
}),
  $(".box-image img").click(function () {
    let e = $(this).attr("src");
    $(".header").css("backgroundImage", `url(${e})`);
  }),
